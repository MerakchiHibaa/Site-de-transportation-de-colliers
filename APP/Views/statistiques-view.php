...
class Statistiques_view {
    ...
    public function display() {
        ...
        <div class="counter-up">
          <div class="content">
            <div class="box">
              ...
              <div class="counter">'. $_controller->getUsersNumber() .'</div>
              <div class="text"> Utilisateurs </div>
            </div>
            <div class="box">
              <div class="icon"><i class="fa fa-car" aria-hidden="true"></i></div>
              <div class="counter">'. $_controller->getTransporteursNumber() .'  </div>
              <div class="text"> Transporteurs</div>
            </div>
            <div class="box">
              <div class="icon"><i class="fas fa-user-tie"></i></div>
              <div class="counter">'. $_controller->getClientsNumber() .'</div>
              <div class="text"> Clients</div>
            </div>
            <div class="box">
              <div class="icon"><i class="fas fa-bullhorn"></i></div>
              <div class="counter">'. $_controller->getAnnncesNumber() .' </div>
              <div class="text"> Annonces</div>
            </div>
            <div class="box">
              <div class="icon"><i class="fas fa-user-check"></i></div>
              <div class="counter"> '. $_controller->getCertifiedNumber() .'</div>
              <div class="text">Transporteurs Certifiés</div>
            </div>
            <div class="box">
              <div class="icon"><i class="far fa-handshake"></i></div>
              <div class="counter"> '. $_controller->getTrajetsNumber() .'</div>
      ...
      <div style="text-align:center; 
       ...
       $annonces= $_controller->getTopAnnonces() ;
