...
<section class="vh-100" style="background-color: #f4f5f7;">
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
     ...
     echo'   <a href="./updateProfileUser.php?id='. $_SESSION['userID'].'  ">      <i style="color: black ; margin-top: 40px ; font-size: 2.5rem;" class="far fa-edit mb-5"></i>  </a> 
            </div>
            <div class="col-md-8">
...
case "refuse" : 
                    echo'  <p style=\'font-weight:600 ;\' class="text-center text-danger" > <i style="padding: 5px" class="fas fa-times"></i>   Refusée </p>
                      <p style=\'font-size:1rem ;\' class="text-center " >' ;
                          $_controller->getJustificatif($_SESSION['userNom'] , $_SESSION['userPrenom'])  ;
                          echo' </p>' ;
          ...
          echo'  <td>
              <div class="ms-3">' ;
                ...
                if($value['statut'] =="0") { 
                  ...
                  echo' <a  href= "annonceResponders.php?ida='. $value['ID_annonce'].' > Voir qui a répondu à votre annonce </a> ';
                 } else {
                  echo' <a   class="text-muted mb-0" > Pas de réponse  </a> ';
...
echo'
 ...
 echo' <h1 style="margin-left: 7rem ; margin-top: 3.5rem ; font-size: 2.5rem ;"> <i style="margin: 0 15px ;"  class="fa fa-history" aria-hidden="true"></i>
         ...
         <tr>
           <td>
             <div class="d-flex align-items-center">
               ...
               <div class="ms-3">
                 <p class="fw-primary mb-1"> echo $i </p>
               </div>
             </div>
           </td>
           <td>
             ...
             <div class="d-flex align-items-center">
               ...
               <div class="ms-3">' ;
                ...
                echo'  <p class="fw-primary mb-1">  "Vous n\'avez pas encore noté ce trajet." </p>' ;
                 ...
                 echo' <p class="fw-primary mb-1"> '. $value['note'].'/5 </p>' ;
             ...
             <div class="d-flex align-items-center">
               ...
               <p class="fw-primary mb-1">  "Le site prend 30% :' .$value['price']*0.3 .'</p>
                  ...
                  echo'  <!---actions---->
                    ...
                    <td>' ;
                       if($value['termine'] == '0') {  
                      echo'  <a class="btn btn-success btn-sm" href="?signalFinished='. $value['ID_trajet'].'" > <i class="fas fa-check"> </i> Signaler comme terminé </a>
';
     ...
     echo' <a href="rate.php?id='. $value['ID_transporteur'].'&idtr='. $value['ID_trajet'].'" class="btn btn-warning btn-sm " > <i class="fas fa-star"> </i> Noter </a>' ;
                          ...
                          echo' <a href="rate.php?id='. $value['ID_transporteur'].'&idtr='. $value['ID_trajet'].'" class="btn btn-warning btn-sm disabled" > <i class="fas fa-star"> </i> Noter </a>' ;

                        }
echo'      <a href="report.php?id='. $value['ID_trajet'].'&idsd='. $value['ID_transporteur'].'&ids='. $_SESSION['userID'].'" class="btn btn-danger btn-sm ">       <i class="fas fa-exclamation-triangle"></i> 
